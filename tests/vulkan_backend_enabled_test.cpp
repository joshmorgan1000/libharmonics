...
TEST(VulkanBackendEnabledTest, DeviceRoundTripPreservesTensor) {
...
TEST(VulkanBackendEnabledTest, SelectGpuBackendVulkan) {
    EXPECT_EQ(harmonics::select_gpu_backend(), harmonics::GpuBackend::Vulkan);
}
