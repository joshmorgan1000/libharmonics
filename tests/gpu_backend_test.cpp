...
TEST(GpuBackendTest, DeviceRoundTripPreservesTensor) {
...
TEST(GpuBackendTest, SelectGpuBackendMatchesBuild) {
#if HARMONICS_HAS_VULKAN
    EXPECT_NE(harmonics::select_gpu_backend(), harmonics::GpuBackend::None);
#else
